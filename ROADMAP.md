...
**Current position:** Days 1–50 complete. Next coding day: **Day 51 — Schedule
generator**.
...
- [ ] Day 51 — Schedule generator (yearly calendars, rotate venues)
- [ ] Day 52 — Expanded points (bonuses, penalties, configurable scoring)
