from .cup_grid import create_cup_drivers, create_cup_teams, waiting_applicants
from game.models import Driver, Manufacturer, Network, Sponsor, Track


def create_initial_teams():
    """Return a fresh Cup-sized paddock for a new career."""

    return create_cup_teams()
...
def create_initial_drivers():
    """Return a fresh Cup-sized grid for a new career."""

    return create_cup_drivers()
